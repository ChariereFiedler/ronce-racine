...
- **MOI** quand : <cas d'usage précis>
- **<skill-voisin>** à la place si : <frontière>

## Principe

<1–2 phrases : l'insight central, la sortie attendue. Ce qui distingue un bon résultat d'un mauvais.>

## Contexte à rassembler (avant d'agir)

- Framework + commandes : lire `package.json` / `Cargo.toml` / `Makefile` / config CI
- Lire un voisin existant et copier ses conventions avant d'inventer
- <données / fixtures / emplacements de référence du projet>
...
<Pour un workflow complexe, fournir une checklist copiable :>
```
- [ ] Étape 1
- [ ] Étape 2
```
...
| Excuse | Réalité |
|--------|---------|
| « <excuse fréquente> » | <pourquoi c'est faux> |

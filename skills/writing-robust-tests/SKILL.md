...
- Advanced techniques (automated mutation testing, contract harness, deterministic fixtures): a dedicated `testing-advanced` reference is planned for this skill (coming); until then, apply §2 to §5 manually.
